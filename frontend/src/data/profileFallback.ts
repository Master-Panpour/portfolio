...
export const profileFallback: Profile = {
  ...
  links: [
    {
      label: "LinkedIn",
      url: "https://www.linkedin.com/in/sanskar-jaiswal-639369329/"
    },
    {
      label: "GitHub",
      url: "https://github.com/Master-Panpour"
    },
    {
      label: "TryHackMe",
      url: "https://tryhackme.com/p/MESSHIN"
    }
  ],
  metrics: [
  ...
  focusAreas: [
    {
      ...
      description: "Combining offensive testing with defensive detection, forensics, and incident response workflows."
    },
    {
      name: "AI-Driven Security",
      description: "Using machine learning, URL intelligence, and adaptive model fusion for phishing and web threat detection."
    },
    {
      name: "Reconnaissance Automation",
      description: "Building scripted workflows for enumeration, network analysis, web discovery, and CTF operations."
    }
  ],
  bulletin: {
